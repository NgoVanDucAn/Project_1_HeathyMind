...
<section class="top">
    ...
    <div class="layout">
        <h1 style="margin-top: 100px;" class="title">All Poses</h1>
        <br>
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                if($page>=2){   
                      echo "<a href='poses.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='poses.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='poses.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='poses.php?page=".($page+1)."'>  Next </a>";   
                }   
