        ...
        <div class="container">
            <div class="row justify-content">
                ...
                <div class="search">
                    ...
                    <input type="text" name="query" class="search-txt" placeholder="Tìm Kiếm">
        ...
        <div class="container">
            <div class="row">
                <div class="section-title" id="aboutus">
                    <h2 data-title="Introduce:">About Aerobic</h2>
                </div>
            </div>
            <div class="row">
                <div class="about-item">               
                    <h2>Do you know ?</h2>
                    <p>
                    - The term "Aerobic" was used by Louis Pasteur - a famous French doctor
                    for the first time in 1875. He explained that Aerobic is of Greek origin
                    “Aerob”, which means “with oxygen”, because it is related to the activity of mobilization and use
                    oxygen in too the volume swapment of the base. Aerobic exercise is basically
                    the post the file sports continuously with low and medium intensity over a range
                    long time.
                    </p>
                    <form action="2.General.php">
                        <button class="btn">Start</button>
