...
<section class="top">
    ...
    <div class="layout">
        <h1 style="margin-top: 100px;" class="title">Poses by Anatomy</h1>
        <br>
        ...
        <div class="content">
            <div>
            <div>   
                <a ><h2 class="index">Musculoskeletal.System</h2></a>
            </div>
            <hr>
            ...
            <?php
              ...
              $sql = "SELECT * FROM `poses` WHERE `anatomy` = ? LIMIT $start_from, $per_page_record";     
              $rows = sqlGetAll($sql,'s', 'Musculoskeletal.System');
              $count =1;
                foreach ($rows as $row):
                    if($count%8 != 0){
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                $query = "SELECT COUNT(*) FROM `poses` WHERE `anatomy` = 'Musculoskeletal.System'";     
                ...
                if($page>=2){   
                      echo "<a href='5.Musculoskeletal.System.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='5.Musculoskeletal.System.System.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='5.Musculoskeletal.System.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='5.Cardiovascular.System.php?page=".($page+1)."'>  Next </a>";   
                }   
