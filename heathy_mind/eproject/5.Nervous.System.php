...
<section class="top">
    ...
    <div class="layout">
        ...
        <div class="content">
            <div>
            <div>   
                <a><h2 class="index">Nervous.System</h2></a>
            </div>
            <hr>
            ...
            <?php
              ...
              $rows = sqlGetAll($sql,'s', 'Nervous.System');
              $count =1;
                foreach ($rows as $row):
                    if($count%8 != 0){
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                $query = "SELECT COUNT(*) FROM `poses` WHERE `anatomy` = 'Nervous.System'";     
                ...
                if($page>=2){   
                      echo "<a href='5.Nervous.System.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='5.Nervous.System.System.System.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='5.Nervous.System.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='5.Nervous.System.php?page=".($page+1)."'>  Next </a>";   
                }   
