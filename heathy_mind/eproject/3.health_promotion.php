...
<section class="top">
    ...
    <div class="layout">
        <h1 style="margin-top: 100px;" class="title">Poses by Benefit</h1>
        <br>
        ...
        <div class="content">
            <div>
            <div>   
                <a  ><h2 class="index">Health promotion</h2></a>
            </div>
            <hr>
            ...
            <?php
              ...
              $sql = "SELECT * FROM `poses` WHERE benefit = ? LIMIT $start_from, $per_page_record";     
              $rows = sqlGetAll($sql,'s', 'Health_Promotion');
              $count =1;
                foreach ($rows as $row):
                    if($count%8 != 0){
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                $query = "SELECT COUNT(*) FROM `poses` WHERE benefit = 'Health_Promotion'";     
                ...
                if($page>=2){   
                      echo "<a href=3.health_promotion.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='3.heallth_promotion.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='3.health_promotion.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='3.health_promotion.php?page=".($page+1)."'>  Next </a>";   
                }   
