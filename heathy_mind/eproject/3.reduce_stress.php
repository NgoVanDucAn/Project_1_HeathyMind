...
<section class="top">
    ...
    <div class="layout">
        ...
        <div class="content">
            <div>
            <div>   
                <a  ><h2 class="index">Reduce Stress</h2></a>
            </div>
            <hr>
            ...
            <?php
              ...
              $rows = sqlGetAll($sql,'s', 'Reduce_Stress');
              $count =1;
                foreach ($rows as $row):
                    if($count%8 != 0){
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                $query = "SELECT COUNT(*) FROM `poses` WHERE benefit = 'Reduce_Stress'";     
                ...
                if($page>=2){   
                      echo "<a href='3.reduce_stress.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='3.reduce_stress.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='3.reduce_stress.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='3.reduce_stress.php?page=".($page+1)."'>  Next </a>";   
                }   
