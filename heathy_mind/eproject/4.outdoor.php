    ...
    <div class="layout">
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                $query = "SELECT COUNT(*) FROM `poses` WHERE `type` = 'Outdoor'";     
                ...
                if($page>=2){   
                      echo "<a href='4.outdoor.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='4.outdoor.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='4.outdoor.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='4.outdoor.php?page=".($page+1)."'>  Next </a>";   
                }   
