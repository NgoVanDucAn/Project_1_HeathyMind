...
if ($delete_id) {
    //delete form db
    $sql = "DELETE FROM poses WHERE poses_id = $delete_id";
  ...
  <section class="home-section">
    ...
    <div>
      ...
      <form  method="POST" action="#">
        ...
        <table class="table">
          <caption>List of posses</caption>
            <thead>
              <tr>
                <th scope="col">#ID</th>
          ...
          <tbody>
            ...
            <?php
              ...
              $query = "SELECT * FROM poses LIMIT $start_from, $per_page_record";     
              $rs_result = mysqli_query ($conn, $query);    
              while ($row = mysqli_fetch_array($rs_result)) {  
            ?>
            <tr>
              <th scope="row">
                  <a class="btn btn-outline-info" href="./edit.php?poses_id=<?php echo $row['poses_id'] ?>"><?php echo $row['poses_id'] ?></a>
              </th>
        ...
        <div class="pagination" id="nav">    
            <?php  
                ...
                if($page>=2){   
                      echo "<a href='posesdata.php?page=".($page-1)."'>  Prev </a>";   
                }       
                            
                for ($i=1; $i<=$total_pages; $i++) {   
                  if ($i == $page) {   
                        $pagLink .= "<a class = 'active' href='posesdata.php?page="  
                                                          .$i."'>".$i." </a>";   
                  }               
                  else  {   
                      $pagLink .= "<a href='posesdata.php?page=".$i."'>   
                                                          ".$i." </a>";     
                  }   
                };     
                echo $pagLink;   
                ...
                if($page<$total_pages){   
                  echo "<a href='posesdata.php?page=".($page+1)."'>  Next </a>";   
                }   
